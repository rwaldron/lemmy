...
EXECUTABLE_DIRECTORY = $(DEPLOYMENT_DIRECTORY)/.bin
...
build:
	$(EXECUTABLE_DIRECTORY)/coffee --compile --output . $(SOURCE_DIRECTORY)
	$(EXECUTABLE_DIRECTORY)/coffee --compile --output $(LIBRARY_DIRECTORY) $(SOURCE_DIRECTORY)/$(LIBRARY_DIRECTORY)
	$(EXECUTABLE_DIRECTORY)/coffee --compile --output $(MODULES_DIRECTORY) $(SOURCE_DIRECTORY)/$(MODULES_DIRECTORY)
	$(EXECUTABLE_DIRECTORY)/coffee --compile --output $(TESTING_DIRECTORY) $(SOURCE_DIRECTORY)/$(TESTING_DIRECTORY)
